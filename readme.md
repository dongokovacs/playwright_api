...
(if succes folder structure created)
or if we have package.json only npm i
...
I’m thinking of making an apple pie. It’s not chocolate, it’s not pudding.
I’m not an expert in TDD — Test Driven Development, because I’m not a developer. However, I understand that in TDD, tests must be written and coded before the project is launched.